...
# Comma-separated list in env, e.g. "yourapp.up.railway.app,127.0.0.1,localhost"
...
# Comma-separated list in env, e.g. "https://yourapp.vercel.app,http://localhost:5173"
